...
import { InternalCurveFn, montgomery, type CurveFn as XCurveFn } from "./abstract/montgomery";
import {
    bytesToHex,
    bytesToNumberLE,
    ensureBytes,
...
function ed25519_domain(data: Uint8Array, ctx: Uint8Array, phflag: boolean) {
    ...
    return concatBytes(
        fromUtf8('SigEd25519 no Ed25519 collisions'),
 ...
 */
export const x25519: InternalCurveFn = /* @__PURE__ */ (() =>
    montgomery({
        P: ED25519_P,
        a: BigInt(486662),
...
export const hashToRistretto255 = (msg: Uint8Array, options: htfBasicOpts): RistPoint => {
    const d = options.DST;
    const DST = typeof d === 'string' ? fromUtf8(d) : d;
