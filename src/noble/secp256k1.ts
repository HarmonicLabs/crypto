...
export const secp256k1PointToBytes = pointToBytes; 
const numTo32b = (n: bigint) => numberToBytesBE(n, 32);
const modP = (x: bigint) => mod(x, secp256k1P);
const modN = (x: bigint) => mod(x, secp256k1N);
const Point = secp256k1.ProjectivePoint;
export const Secp256k1Point = secp256k1.ProjectivePoint;
...
export const signSchnorr = schnorrSign;
export const verifySchnorr = schnorrVerify;
...
{
  return secp256k1.sign( data, privateKey, { extraEntropy } ).toCompactRawBytes()
}

const myDefaultVerOpts: VerOpts = { lowS: true, prehash: false };
...
{
  return secp256k1.verify( sig, msgHash, pubKey, myDefaultVerOpts );
}