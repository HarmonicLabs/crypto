...
import { concatUint8Array, toHex } from "@harmoniclabs/uint8array-utils";
import {
    type AffinePoint,
    type BasicCurve,
    type Group,
...
import { abool, ensureBytes, type FHash, type Hex, memoized, numberToBytesLE, validateObject, aInRange, bytesToNumberLE  } from './utils.js';
...
export function twistedEdwards(curveDef: CurveType): CurveFn {
    ...
    class Point implements ExtPointType {
        ...
        toHex(): string {
            return toHex(this.toRawBytes()); // Same as toRawBytes, but returns string.
        }
    }
    ...
    function hashDomainToScalar(context: Hex = new Uint8Array(), ...msgs: Uint8Array[]) {
        const msg = concatUint8Array(...msgs);
    ...
    function sign(msg: Hex, privKey: Hex, options: { context?: Hex } = {}): Uint8Array {
        ...
        const res = concatUint8Array(R, numberToBytesLE(s, Fp.BYTES));
