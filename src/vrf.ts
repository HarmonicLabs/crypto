...
import { bigpoint, bigpointToUint8Array, deriveEd25519PublicKey_sync, encodeInt, getExtendEd25519PrivateKeyComponents_sync, getExtendEd25519PrivateKeyComponentsAsBytes_sync, pointFromBytes, scalarFromBytes, scalarMul, scalarMultBase, scalarToBytes } from "./ed25519";
import { sha2_512_sync } from "./sha2_512";
import { byte } from "./types";
import { x25519 } from "./noble/ed25519";
import { add_scalars, decompressCompressedEdwardsY, ED25519_BASEPOINT_POINT, EdwardsPoint, FieldElem51, mul_scalars, negate_scalar, scalar_from_bytes_mod_order_wide } from "./rust_vrf_reimpl";
    ...
    implements IVRFProof
{
    ...
    {
        return vrf_ed25519_sha512_ell2_generate_proof(
            secret_key,
            public_key,
            alpha_string
        );
...
*/
function proof_to_hash( proof: VRFProof ): Uint8Array & { length: 64 }
{
...
/*
export function vrfProofToBytesProof( proof: VRFProof )
{
    return {
...
function vrf_ed25519_sha512_ell2_hash_to_curve(
    public_key: Uint8Array,
    alpha_string: Uint8Array
): EdwardsPoint 
{
...
function scalar_hash_from_bytes( input: Uint8Array ): Uint8Array
{
...
export function vrf_ed25519_sha512_ell2_prove(sk: Uint8Array, alpha: Uint8Array): VRFProof
{
    ...
    console.log( "H        ", toHex( H ) );
    console.log( "alpha    ", toHex( alpha ) );
    console.log( "pk       ", toHex( pk ) );
    console.log( "extension", toHex( extension ) );
